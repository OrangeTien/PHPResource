...
// +------------------------------------------------------------------------+
$note = base64_decode('');
...
function check_($check) {
    $file    = file_get_contents('http://api.topide.com/json/playtube.php?code=' . $check);
    $check   = json_decode($file, true);
    return $check;
}
function check_success($check) {
    $file    = file_get_contents('http://api.topide.com/json/playtube.php?code=' . $check . '&success=true');
    $check   = json_decode($file, true);
    return $check;
}
